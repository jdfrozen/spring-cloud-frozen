package com.frozen.springbootcomponent.aop;

import com.frozen.springbootcomponent.annocation.AopAnnocation;
...
public class OperatorAspect {
    ...
    @Pointcut("@annotation(com.frozen.springbootcomponent.annocation.AopAnnocation)")
