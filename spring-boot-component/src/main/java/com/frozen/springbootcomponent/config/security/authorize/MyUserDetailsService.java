package com.frozen.springbootcomponent.config.security.authorize;

import com.frozen.springbootcomponent.po.Role;
import com.frozen.springbootcomponent.service.RoleService;
...
public class MyUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        com.frozen.springbootcomponent.po.User user = userService.getByUsername(username);
        if (user == null) {
